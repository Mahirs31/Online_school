<div class="navbar">
			...
			<ul class="list">
				<b style="color:white;float:left;line-height:50px;margin-left:15px;font-family:Cooper Black;">Online School</b>
			<?php
				...
				<li><a href="student_result.php">View Results</a></li>
